  ...
  async execute(client, interaction) {
    const embed = new EmbedBuilder()
      ...
      .setFields([
        ...
        {
          name: '**/커스텀**',
          value: '주사위식을 여러개 입력할 수도 있는 커스텀 주사위입니다. 하나의 주사위식은 공백으로 구분합니다. 보정치는 `+숫자` 혹은 `-숫자`로 감지하며 하나의 주사위식에 여러개의 다이스를 입력할 수 있습니다. ex) `D20+2D40`\n\n같은 주사위식을 여러번 굴리고 싶은 경우 `*숫자`를 이용해 입력하면 됩니다. ex) `D20+2D40*4` 이렇게 하면 같은 주사위식이 네 번 실행됩니다.',
        },
      ]);
